package com.delu.ancienttimes.server.entity.custom;
...
public class ModBoatEntity extends Boat {
    ...
    public ModBoatEntity(Level level, double pX, double pY, double pZ) {
        this(ATEntities.MOD_BOAT.get(), level);
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case MEAL -> ModItems.MEAL_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.MEAL.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        MEAL(ModBlocks.MEAL_PLANKS.get(), "meal");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, MEAL);
        }
    }
}