...
import com.delu.ancienttimes.server.entity.goal.BlockFindGoal;
import com.delu.ancienttimes.server.tags.ModTags;
import com.delu.ancienttimes.server.util.NbtUtils;
...
public class Trioclantus extends Animal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ATEntities.TRIOCLANTUS.get().create(pLevel);
    }
