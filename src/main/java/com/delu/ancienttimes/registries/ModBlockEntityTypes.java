...
import com.delu.ancienttimes.server.block.ChiselableBlockEntity;
import com.delu.ancienttimes.server.entity.ModHangingSignBlockEntity;
import com.delu.ancienttimes.server.entity.ModSignBlockEntity;
...
public class ModBlockEntityTypes {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, AncientTimes.ID);
