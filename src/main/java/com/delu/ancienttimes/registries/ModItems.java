...
import com.delu.ancienttimes.server.item.DiamondChisel;
import com.delu.ancienttimes.server.item.MagnifyingGlass;
import com.delu.ancienttimes.server.item.RavenheadsFruit;
import com.delu.ancienttimes.server.item.StateModificationBlockItem;
import com.delu.ancienttimes.server.item.custom.ModBoatItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, AncientTimes.ID);
    ...
    public static final RegistryObject<Item> TRIOCLANTUS_SPAWN_EGG = registerWithCreativeModeTab("trioclantus_spawn_egg", ModCreativeTabs.ANCIENT_TIMES_TAB, () -> new ForgeSpawnEggItem(ATEntities.TRIOCLANTUS, 0x835832, 0x668639, new Item.Properties()));
    public static final RegistryObject<Item> SCALEMOUFLIS_SPAWN_EGG = registerWithCreativeModeTab("scalemouflis_spawn_egg", ModCreativeTabs.ANCIENT_TIMES_TAB, () -> new ForgeSpawnEggItem(ATEntities.SCALEMOUFLIS, 0x40643b, 0xa19a5e, new Item.Properties()));
    public static final RegistryObject<Item> RUMOROXL_SPAWN_EGG = registerWithCreativeModeTab("rumoroxl_spawn_egg", ModCreativeTabs.ANCIENT_TIMES_TAB, () -> new ForgeSpawnEggItem(ATEntities.RUMOROXL, 0x6e1425, 0xed767b, new Item.Properties()));
